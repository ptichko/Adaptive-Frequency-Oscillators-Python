...
def run():
    ...
    ax1.set_title('Adaptive-Frequency Hopf Oscillator with Hebbian Learning')
    ax1.set_xlabel('Time')
    ax1.set_ylabel('W (Angular Frequency)')
    ax1.legend([str(v) for v in e_vals])
    ...
    ax2.set_title('Adaptive-Frequency Hopf Oscillator with Hebbian Learning')
    ax2.set_xlabel('Time')
    ax2.set_ylabel('W (Angular Frequency)')
    ax2.legend([str(v) for v in w0_vals])
    ...
    ax3.set_title('Adaptive-Frequency Hopf Oscillator with Hebbian Learning')
    ax3.set_xlabel('Time')
    ax3.set_ylabel('W (Angular Frequency)')
    ...
    ax4a.set_title('Dynamics of Frequency Adaptation')
    ax4a.set_xlabel('Time')
    ax4a.set_ylabel('W (Angular Frequency)')
    ...
    ax4b.set_title('Input Signal and Oscillator')
    ...
    ax5.set_title(f'Phase Portrait: e = {e}')
    ax5.set_xlabel('x')
    ax5.set_ylabel('y')
    ...
    ax6b.set_ylabel('w')
    ax6b.set_title('Frequency Adaptation')
    ...
    ax6c.set_title('Oscillation (y-var) and Input Signal (dashed)')
    ...
    ax7.set_title('Adaptive-Frequency Hopf Oscillator with Hebbian Learning')
    ax7.set_xlabel('Time')
    ax7.set_ylabel('W (Angular Frequency)')
    ax7.legend([str(v) for v in w0_vals])
    ...
    for i, ax in enumerate(axes8):
        ...
        ax.set_title(f'{w0_vals[idx]}-Hz Oscillator')
        if i == 0:
            ax.legend()
